...
public class AlarmBroadcast extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent intent1 = new Intent(context, NotificationMessages.class);
        ...
        RemoteViews contentView = new RemoteViews(context.getPackageName(), R.layout.activity_notification_messages);
        ...
        contentView.setTextViewText(R.id.message, text + time);
        contentView.setTextViewText(R.id.date, desc);
